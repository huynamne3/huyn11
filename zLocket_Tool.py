...
class zLocket:
    def __init__(self, device_token: str="", target_friend_uid: str="", num_threads: int=1, note_target: str=""):
        ...
        self.NAME_TOOL="By DangXuanGiang.Site"
        ...
        self.telegram='DangXuanGiang'
        self.author='DangXuanGiang'
        self.messages=[]
        ...
        if os.name == "nt":
            os.system(
                f"title 💰 {self.NAME_TOOL} {self.VERSION_TOOL} by DangXuanGiang.Site 💰"
         )
